export default function AboutPaymentAndDeliveryPage() {
  return (
    <div className="p-[2vmax] document">
      ...
      <h2>Зона доставки</h2>
      <p>
        Москва в пределах МКАД <br /> ЗА МКАД?
      </p>

      <h2>Стоимость доставки</h2>
      <p>
        Бесплатно, если вы выбрали самовывоз или ваш адрес находится внутри
        бульварного кольца
      </p>
      <ul>
        <li>в пределах Садового кольца - 300 руб.</li>
        <li>в пределах ТТК - 700 руб.</li>
        <li>в пределах МКАД - 1000 руб.</li>
      </ul>

      <p>Среднее время доставки 40 минут в зависимости от адреса</p>
